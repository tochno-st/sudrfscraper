...
- Убедитесь, что у вас установлен браузер Firefox. Если установлен, то попробуйте в адресной строке указать `localhost:8000` — должен открыться интерфейс приложения.
