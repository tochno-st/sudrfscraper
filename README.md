# SUDRF Scraper: Интерактивный поиск дел и текстов судебных решений судов общей юрисдикции первой и апелляционной инстанций
...
Некоторые суды используют капчу, поэтому иногда вам придется вводить ее вручную. Мы постарались минимизировать требуемое количество вводов капчи. Парсер собирает только открытые данные, размещенные на сайтах судов.
